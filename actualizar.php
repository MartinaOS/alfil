...
$sql=" UPDATE servicios SET Nombre_servicios='$nom', Direccion='$dir', RFC='$rfc', Telefono='$tel', Clasificacion='$clasif', Foto='$foto', Latitud='$lat', Longitud='$longit' where id_servicios='$id'";
